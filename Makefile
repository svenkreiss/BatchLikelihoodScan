...
test-twoBin: tests/twoBin/models/twoBinStandard.root
	...
	cd tests/twoBin; python ../../BatchLikelihoodScan/plot.py --subtractMinNLL
	@echo "The result of the twoBin test is in tests/twoBin/PL_data.root. You can for example look at the scanned nll values in ROOT with profiledNLL->Draw(\"COLZ\")."
