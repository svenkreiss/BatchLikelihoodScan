...
This was originally developed for the paper arXiv:1401.0080 and the 
Decouple package (http://github.com/svenkreiss/decouple). 
"""
...
def makeMeasurement( name="meas", outDir="./models/", prefix="standard" ):
